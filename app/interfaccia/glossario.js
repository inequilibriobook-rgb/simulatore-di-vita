...
(function (G) {
  ...
  var CATEGORIE = [
    ...
    { id: 'distribuzione', titolo: 'Leggere un mucchio di giocate',
      breve: 'Quando la stessa scena si gioca mille volte: media, mediana, percentili, e la forma di tutti i casi.',
      chiavi: ['giocata', 'ripetizioni', 'valutazioni', 'campione', 'distribuzione', 'media',
