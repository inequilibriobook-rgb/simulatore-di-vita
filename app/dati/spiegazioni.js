...
window.Spiegazioni = {
  ...
  parole: {
    ...
    ripetizione: {
      nome: 'La ripetizione', sigla: '',
      breve: 'Una prova sola. La stessa scena vissuta una volta, da cima a fondo, con i suoi tiri di dado. Rifarla vuol dire ricominciare da capo, con gli stessi gesti e dadi nuovi.',
      esempio: 'Immagina di rivivere la stessa mattina cento volte, sempre uguale nelle condizioni di partenza e ogni volta con dadi nuovi: cento ripetizioni sono questo, cento mattine identiche vissute una dopo l’altra. È quello che il simulatore conta quando ripete una scena molte volte.\n\nLa parola serve a non confondersi con i gesti. Una scena da quattro gesti, ripetuta cento volte, fa quattrocento gesti e cento ripetizioni, e il numero da guardare è il secondo, perché una mattina vissuta una volta sola resta una prova sola, per quanti gesti ci stiano dentro. Si veda anche la voce «valutazioni».' },
    ripetizioni: {
      nome: 'Le ripetizioni', sigla: '',
      breve: 'Quante volte si chiede al simulatore di rifare da capo la stessa identica scena. È un numero che scegli tu, e dice soltanto quante ripetizioni vuoi.',
    ...
    valutazioni: {
      ...
      breve: 'Quanti conti ha fatto in tutto il simulatore: i gesti distinti della scena, moltiplicati per quante volte l’hai ripetuta.',
      esempio: 'Quattro gesti ripetuti cento volte fanno quattrocento valutazioni. È il numero che inganna di più, e conviene sapere perché.\n\nLe ripetizioni vere restano cento, perché le quattro valutazioni di uno stesso giro appartengono alla stessa mattina e non valgono come quattro prove separate: se quella mattina era storta, lo erano tutte e quattro insieme. Chi scambia le valutazioni per il campione (quante prove davvero diverse hai in mano) crede di sapere il quadruplo di quello che sa. Si veda la voce «campione».' },
    campione: {
    ...
    semiampiezza: {
      ...
      esempio: 'Quando leggi «49,3 ± 0,4», quello 0,4 è la semiampiezza, e vuol dire che è ragionevole pensare che il valore vero stia fra 48,9 e 49,7.\n\nServe a rispondere alla domanda «quante ripetizioni bastano?». Non si fissa un numero di ripetizioni a tavolino: si guarda la semiampiezza, e ci si ferma quando è scesa abbastanza per la decisione da prendere. Conviene però saperlo prima di cominciare, perché per dimezzarla servono quattro volte le ripetizioni, non il doppio.' },
    numerosita: {
      nome: 'La numerosità', sigla: 'n',
      breve: 'Quanti casi ci sono nel gruppo su cui si fa il conto. Nel simulatore è quasi sempre il numero di ripetizioni (le prove intere della stessa scena).',
      esempio: 'La lettera n accanto a un grafico dice su quante prove poggia quello che stai guardando: «n = 2.000» vuol dire che quella curva è nata ripetendo duemila volte la stessa scena.\n\nÈ il numero più importante, e insieme il più dimenticato, perché la stessa percentuale, detta su dieci casi o su duemila, dice due cose diverse. Attenzione anche a non confonderlo con le valutazioni: una ripetizione di venti gesti fa una ripetizione sola e venti valutazioni, e se conti le seconde al posto delle prime la misura sembra molto più solida di quanto sia.' },
    scarto_z: {
    ...
    due_assi: {
      ...
      breve: 'Quanti gesti diversi contiene una scena, e quante volte quella scena viene rifatta da capo. Sono due misure separate, e confonderle gonfia i conti.',
      esempio: 'Leggere mille volte un libro di quaranta pagine non lo fa diventare un libro di quarantamila pagine: hai letto molto, ma il libro è sempre quello.\n\nUna scena da quaranta gesti, ripetuta mille volte, fa quarantamila calcoli, ma i gesti restano quaranta e le ripetizioni restano mille. Ripetere il dado non aggiunge gesti alla scena, e allungare la scena non rende più sicuro il risultato.\n\nPer questo conviene diffidare dei numeri grandi buttati lì senza spiegazione: un numero che non dice da quale dei due assi viene, di solito, serve soltanto a far sembrare solida una misura che non lo è.' },
    accumulatore: {
    ...
    percentile: {
      ...
      esempio: 'È la stessa idea delle curve di crescita dal pediatra. Un bambino al decimo percentile non è per forza basso: vuol dire che dieci bambini su cento stanno sotto di lui, e novanta sopra, e il pediatra lo dice ai genitori proprio così.\n\nQui i percentili servono a dire quanto la scena è ballerina. Il simulatore guarda il decimo e il novantesimo, come fa il libro: fra i due stanno ottanta ripetizioni su cento, e se quella distanza è larga la stessa mattina può finire in modi molto diversi.' },
    varianza: {
    ...
    monte_carlo: {
      ...
      breve: 'Rifare molte volte la stessa scena, con dadi sempre nuovi, e guardare la forma di quello che esce invece del singolo risultato.',
      esempio: 'Il nome viene dal casinò di Monte Carlo, e l’idea è la stessa della roulette: per sapere come si comporta un tavolo da gioco non basta un giro solo, bisogna farne tanti e guardare come vanno, perché una serata fortunata non dice niente sul tavolo.\n\nIl metodo ha ottant’anni, e non serve sapere altro per usarlo. Una ripetizione sola (una prova intera della scena) dice che cosa è capitato quella volta lì. Mille ripetizioni dicono che cosa capita di solito, quanto il risultato varia, e quanto spesso va molto male.' },
    wilson: {
    ...
    granularita: {
      ...
      breve: 'Quanto è fine il taglio con cui si descrive una scena: di quanti gesti distinti è fatta. Non quante volte la si rifà da capo, ma in quanti pezzi la si divide.',
    ...
    runner: {
      ...
      breve: 'Lo strumento che esegue le simulazioni molto lunghe: centinaia di migliaia di ripetizioni (prove intere di una scena), archiviate e riprendibili. Il motore calcola un gesto solo; il runner ne calcola cinquecentomila, e li conserva.',
